...
function makeHeader(){
  ...
  function (ev){
    deletePreviousInfo()
      ...
      form.innerHTML += '<input class="form-control" type="text" name="" id="" placeholder="Address">'
...
function makeSummary(){
  ...
  function (ev){
    deletePreviousInfo()
    let form = document.createElement('form')
    form.innerHTML += '<textarea style="word-wrap:break-word;" class="form-control" type="text" name="" id="" placeholder="Summary" rows="7"></textarea>'
    form.innerHTML += '<input type="submit" id="submit" class="btn btn-info btn-block">'
    document.getElementById('show-form').append(form)
    putSummary()
  }
...
function makeSkills(){
  ...
  function(ev){
    ...
    let form = document.createElement('form')
    form.innerHTML += '<input class="form-control" type="text" placeholder="Category ex: Frameworks">'
...
function makeCert(){
  ...
  function (ev){
    ...
    form.innerHTML += '<input class="form-control" type="text" placeholder="Organization">'
    form.innerHTML += '<textarea  oninput="bulletTextArea(event)" rows="7" style="word-wrap:break-word;" class="form-control" placeholder="Description"></textarea>'
